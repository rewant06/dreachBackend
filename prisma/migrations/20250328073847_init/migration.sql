...
-- CreateIndex
CREATE UNIQUE INDEX "Slot_clinicInfoId_key" ON "Slot"("clinicInfoId");
...
-- AddForeignKey
ALTER TABLE "ClinicInfo" ADD CONSTRAINT "ClinicInfo_serviceProviderId_fkey" FOREIGN KEY ("serviceProviderId") REFERENCES "ServiceProvider"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
